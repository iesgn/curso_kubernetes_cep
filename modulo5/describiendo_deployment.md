...
Nosotros, sim embargo, vamos a seguir describiendo los recursos en un fichero yaml. En este caso para describir un despliegue de nginx podemos escribir un fichero [`nginx-deployment.yaml`](files/nginx-deployment.yaml):
